...
function EventDetails({event}: {event: Event}) {
	...
	switch (data.type) {
			...
			return (
				<div className="space-y-2">
					...
					<details className="text-xs">
						<summary className="text-gray-400 cursor-pointer hover:text-gray-300">Input parameters</summary>
			...
			return (
				<div className="space-y-2">
					<div className="flex items-center gap-2">
						...
						{data.agentId && <div className="text-xs text-blue-400">Agent: {data.agentId}</div>}
					</div>
		...
		case "agent-spawn":
			return (
				<div className="space-y-2">
					...
					<details className="text-xs">
						<summary className="text-gray-400 cursor-pointer hover:text-gray-300">Prompt</summary>
		...
		case "summary":
			return <div className="text-xs text-gray-300">📝 {data.summary}</div>
